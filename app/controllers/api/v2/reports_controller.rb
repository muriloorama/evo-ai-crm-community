class Api::V2::ReportsController < Api::V1::BaseController
  ...
  def agents
    ...
    generate_csv('agents_report', 'api/v2/reports/agents')
  end

  def inboxes
    @report_data = generate_inboxes_report
    generate_csv('inboxes_report', 'api/v2/reports/inboxes')
  end

  def labels
    @report_data = generate_labels_report
    generate_csv('labels_report', 'api/v2/reports/labels')
  end

  def teams
    @report_data = generate_teams_report
    generate_csv('teams_report', 'api/v2/reports/teams')
  end
  ...
  def conversation_traffic
    ...
    generate_csv('conversation_traffic_reports', 'api/v2/reports/conversation_traffic')
  end
